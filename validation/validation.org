...
#+begin_src clojure :results pp
  ...
  (def bmeasured (toolkit/measured-batch measured 100))
  (toolkit/invoke-measured bmeasured)

  (dissoc (time/measure* measured {:limit-evals 10000}) :samples)
#+end_src

We see that this reports around 78.0ms.
...
#+begin_src clojure :results pp
  ...
  (dissoc (time/measure* bmeasured {:limit-evals 60000000 :limit-time 2}) :samples)
...
We see that this reports around 115.0ms.
